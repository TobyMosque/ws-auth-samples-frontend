<template>
  <q-page class="p-home row items-center justify-evenly">
    <div class="row">
      ...
      <q-btn v-if="isOnRole('admin')" @click="isAdmin" color="primary" label="Is Admin?"></q-btn>
      <q-btn v-if="isOnRole('developer')" @click="isDeveloper" color="primary" label="Is Developer?"></q-btn>
    </div>
    <div class="row">
      <q-btn v-if="isOnRole('admin')" :to="'/is-admin'" color="primary" label="Admin Page"></q-btn>
      <q-btn v-if="isOnRole('developer')" :to="'/is-developer'" color="primary" label="Developer Page"></q-btn>
    </div>
  </q-page>
</template>
